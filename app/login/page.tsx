...
export default function Login() {
  ...
  return (
    <div className="relative h-screen w-screen bg-gray-50">
      <header className="absolute top-4 left-1/2 -translate-x-1/2">
        <Image src={uitm_logo} alt="Password Manager Logo" className="max-w-40" priority />
      </header>
      <main className="flex h-screen w-screen items-center justify-center bg-gray-50 p-4 sm:p-0">
